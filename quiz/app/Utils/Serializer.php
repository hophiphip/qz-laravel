...
class Serializer
{
     ...
     *  NOTE: Needed to define the initial quiz in the database migration.
     *
     * @return QuizDTO
     */
    public static function SampleQuiz(): QuizDTO {
    ...
    /**
     * Create an array of sample quizzes.
     *  NOTE: Needed to populate the quiz factory for the unit/feature tests.
     *
     * @return array
     */
    public static function SampleQuizzes(): array {
        return [
            Serializer::SampleQuiz(),

            Serializer::CreateQuiz(
                '2',
                'Test two',
                ...[
                    // Question 1
                    Serializer::CreateQuestion('2-1', 'Hehe?', ...[
                        new ChoiceDTO('2-1-2', 'Hehe', true),   // Choice A
                        new ChoiceDTO('2-1-3', 'haha', false),  // Choice B
                        new ChoiceDTO('2-1-4', 'what?', false), // Choice C
                        new ChoiceDTO('2-1-1', '...', false),   // Choice D
                    ]),

                    // Question 2
                    Serializer::CreateQuestion('2-2', 'The correct answers are B and C.', ...[
                        new ChoiceDTO('2-2-1', 'A', false), // Choice A
                        new ChoiceDTO('2-2-2', 'B', true), // Choice B
                        new ChoiceDTO('2-2-3', 'C', true), // Choice C
                        new ChoiceDTO('2-2-4', 'D', false), // Choice D
                    ]),

                    // Question 3
                    Serializer::CreateQuestion('2-3', 'Answer to everything.', ...[
                        new ChoiceDTO('2-3-1', '69', false), // Choice A
                        new ChoiceDTO('2-3-2', '420', false), // Choice B
                        new ChoiceDTO('2-3-3', '39', false), // Choice C
                        new ChoiceDTO('2-3-4', '42', true), // Choice D
                    ]),
                ]
            ),
        ];
